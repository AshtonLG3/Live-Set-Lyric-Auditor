...
**On screen:** App open on the **Dashboard**. Slowly pan the top bar — show `Live-Set Lyric Auditor v0.11.30`, the **runtime badge** ("API mode"), Dashboard/Analysis nav, and **Export Passport**. Land on the **Clip Intake** hero ("Start a Live Variant Passport") showing the two intake modes.
